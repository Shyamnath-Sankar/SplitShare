  ...
  return (
    <div className="min-h-screen bg-gray-50 p-4 pt-[var(--mobile-top-padding)]">
      <div className="max-w-3xl mx-auto">
        ...
        <p className="mt-4">Please note that the Application utilizes third-party services that have their own Terms and Conditions. Below are the links to the Terms and Conditions of the third-party service providers used by the Application:</p>
        <ul className="list-disc ml-6 mt-2">
          ...
          <li><a href="https://www.google.com/analytics/terms/" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">Google Analytics for Firebase</a></li>
        ...
        <strong className="text-xl font-bold mt-6 block">Changes to These Terms and Conditions</strong>
        <p className="mt-2">The Service Provider may periodically update their Terms and Conditions. Therefore, you are advised to review this page regularly for any changes. The Service Provider will notify you of any changes by posting the new Terms and Conditions on this page.</p>

        <p className="mt-4">These terms and conditions are effective as of 2026-03-27</p>

        <strong className="text-xl font-bold mt-6 block">Contact Us</strong>
        <p className="mt-2">If you have any questions or suggestions about the Terms and Conditions, please do not hesitate to contact the Service Provider at contact@genrecai.com.</p>
